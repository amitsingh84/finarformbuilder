    ...
    <div>
      <div class="row">
        <div class="col-4">
            ...
            <img
              src="../../../assets/imgs/logo_okayforms_white.svg"
            />
         
        </div>
        <div class="col-4 d-flex justify-content-center align-items-center">
          <div v-if="controllerName">
            <h4 class="text-white" style="font-size: 1.9rem">
              {{ controllerName }}
            </h4>
          </div>
        </div>
            ...
            <div v-if="showData" class="showSettingStyle">
              ...
              <div class="container-fluid g-0">
                ...
                <div class="bottomSetting">
                  <p>
                    <router-link to="/controller/account-setting"
